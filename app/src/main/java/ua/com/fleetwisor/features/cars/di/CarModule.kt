...
import ua.com.fleetwisor.features.cars.presentation.maintenance.create.MaintenanceCreateViewModel
...
val carModule = module {
    ...
    viewModelOf(::MaintenanceCreateViewModel)
    viewModelOf(::MaintenanceEditViewModel)
}